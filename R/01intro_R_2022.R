...
# No es necesario hacerlo si se utiliza RStudio Cloud
...
# Ejercicio1: ¿Cómo lo harías con el paquete "summarytools"? Escribe y ejecuta el código
...
## 2. Revisar información sobre funciones "read_sav" y "read_dta". 
?read_sav
?read_dta
...
## Ejercicio2: Escribe y ejecuta el código para cargar datos en dta. Usa la función "read_dta"



## Vuelve a cargar los datos desde el archivo en SPSS
...
#Opción 2. Presiona el objeto que quieres ver en el Entorno


## 5.1 Estructura datos ------------------
dim(datos)
### [1] 2520 filas  329 columnas

## 5.1 Listado de columnas de los datos (variables) ---------------
names(datos)
...
print(tabla1)
write.csv2(tabla1, "output/tabla1.csv")

# Descriptivos con summarytools

dfSummary(datos$c08_02)
